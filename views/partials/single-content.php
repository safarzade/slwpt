				...
				<div class="product">
									...
									<div class="slider-wrap" data-lightbox="gallery">
                                        ...
                                        <?php if($product_slider_images && count($product_slider_images)): ?>
                                            <?php foreach ($product_slider_images as $image): ?>
                                                <div class="slide" data-thumb="<?php echo Asset::image('shop/thumbs/dress/3.jpg'); ?>">
                                                    <a href="#" title="Pink Printed Dress - Front View" data-lightbox="gallery-item">
                                                        <img src="<?php echo $image; ?>" alt="Pink Printed Dress">
                                                    </a>
                                                </div>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
					...
					<div class="col_two_fifth product-desc">
						...
						<div class="product-price">
                            ...
                            $product_price_sale = Product::price_sale(get_the_ID());
                            ?>
                            <?php if(intval($product_price_sale) > 0): ?>
                                <del><?php echo $product_price; ?></del>
                                <ins><?php echo $product_price_sale; ?></ins>
                            <?php else: ?>
                                <ins><?php echo $product_price; ?></ins>
                            <?php endif; ?>
