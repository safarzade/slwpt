				...
				<nav id="primary-menu">
					...
					<ul class="sf-js-enabled" style="touch-action: pan-y;">
						...
						<li class="mega-menu sub-menu"><a href="#" class="sf-with-ul"><div>Pages</div></a>
							<div class="mega-menu-content style-2 clearfix" style="display: none; width: 947px;">
						...
						<li class="mega-menu sub-menu"><a href="#" class="sf-with-ul"><div>Shortcodes</div></a>
							<div class="mega-menu-content clearfix" style="display: none; width: 947px;">
								<ul class="mega-menu-column col-5" style="">
							...
							<?php foreach ($items as $pid => $item): ?>
								<tr class="cart_item">
									<td class="cart-product-remove">
										<a href="<?php echo Url::add_args(array(
									...
									<td class="cart-product-quantity">
										<div class="quantity clearfix">
											...
											<input type="text" name="quantity" value="<?php echo $item['count'] ?>" class="qty">
											<input type="button" value="+" class="plus">
										</div>
									</td>

									<td class="cart-product-subtotal">
										<span class="amount"><?php echo $item['count'] * $item['price']; ?></span>
									</td>
								</tr>
							<?php endforeach; ?>
						<?php endif; ?>
